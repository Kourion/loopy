...
/********************************************************/
Icon-menu-bar (reduce gamefield by 40px width) add icon-buttons to the right
Switch to load per button
Create gameboard object
Create gameboardlayout extends chararray[][]
Create tileChar extends char give it (TIle, up, down, left, right) info
Add completeChecker for gameboardlayout
Add random gameboardlayout creator